...
def calculate_similarity(player, df, comps=all_comps, year=19, max_age=45):
    ...
    team_crests = pd.read_csv(path+'data/team_crests.csv', index_col=0)
    ...
    dist_df.to_csv(path+'data/player_similarity.csv')
...
if __name__ == '__main__':
    ...
    player_stats = pd.read_csv(path+'data/player_stats.csv')
